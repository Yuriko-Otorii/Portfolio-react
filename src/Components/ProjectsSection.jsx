        ...
        <ul className="project-list">
          <li className="mb-10">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex justify-center items-center bg-white hidden md:block md:flex-1 w-64 md:m-5">
                <a href="https://bookmark-app-theta.vercel.app/Home" className='flex justify-center items-center'>
                  <p className="text-black">App</p>
                </a>
              </div>

              <div className='flex md:flex-col md:flex-1 md:p-10'>
                <div className="project-title-container">
                  <h3 className="text-3xl md:text-4xl font-bold text-center mb-3">Dog picture collection</h3>
                </div>

                <div className="flex justify-center items-center bg-white h-40 md:hidden">
