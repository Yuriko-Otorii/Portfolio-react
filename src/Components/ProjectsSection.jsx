              ...
              <div className="flex flex-col lg:flex-1 lg:p-10">
                ...
                <div className="discription-container">
                  <p className="my-8 text-xl lg:text-3xl">
                    Mern stack app which Trello-ish task management app. You can
                    create task cards on each board and organize those tasks by
                    drag and drop. Setting a due date and priority for each card
                    and you can check near-due date tasks and high-priority
